...
class ReportsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final payments = MockData.paymentBreakdown();
    final products = MockData.topProducts();
    final maxRevenue = summary.map((e) => e.totalRevenue).reduce((a, b) => a > b ? a : b);
                        ...
                        sections: [
                          for (int i = 0; i < payments.length; i++)
                            PieChartSectionData(
                              ...
                              color: [colors.brand500, AppColors.info, AppColors.warning][i % 3],
                              showTitle: false,
                              radius: 20,
                            ),
                        ],
